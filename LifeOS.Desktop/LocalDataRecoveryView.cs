...
public sealed class LocalDataRecoveryView : UserControl
{
    ...
    private void Render()
    {
        ...
        root.Children.Add(Text(
            "Agenda, follow-ups, work pipeline, work sessions, projects, money pressure and document intake use the shared versioned contract. Other modules remain on their existing paths until migrated deliberately.",
            12,
            "#A9B6CA"));
