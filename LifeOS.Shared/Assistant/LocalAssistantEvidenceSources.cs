        ...
        private IEnumerable<AssistantEvidenceRecord> Records()
        {
            ...
            return SourceType switch
            {
                ...
                [new("g36-evidence-northstar", SourceType, "Northstar evidence summary", "Evidence confirms the review request but contains no approval date.", new(2026,7,14,16,27,0,nz), "LifeOS fictional Group 36 Evidence", AssistantTrustLevel.Direct, "northstar-ocr", "Waiting", IsFictional:true),
                 new("g36-evidence-northstar-stale", SourceType, "Northstar stale missing-evidence record", "This fictional Northstar record is stale. It is missing a current reviewer response, current approval date and current status confirmation, so it cannot establish a confident current status.", new(2026,4,1,10,0,0,nz), "LifeOS fictional Group 36 stale Evidence", AssistantTrustLevel.Direct, "northstar-ocr", "Waiting", IsFictional:true)],
