...
> **Current checkpoint:** LifeOS v28.0.0-alpha.21 is active through Group 204. Provider Adapter Registry & Capability Matrix now declares provider families, ownership and bounded capabilities without loading SDKs, credentials or endpoints; provider writes remain disabled. The preserved v27/Group 120 release candidate remains historical evidence, not a promise that feature development has ended.
...
| Product | Status |
|---|---|
| **LifeOS Desktop** | Current through Group 204, including ordinary-mode Provider Adapter Registry, Connection Health, Configuration Readiness, Device Transfer Review, Local Account & Sync, Relationships, Focus Timer, Agenda, Weekly Review, Life, Household, Documents, Money Pressure, Work Time and Projects, validated forms, actionable problems and local-data recovery |
...
| **Current release lane** | v28 ordinary-mode productization; Provider Adapter Registry and Capability Matrix complete through SG-204 Pack 2 |
...
- [Groups 201-204 - Provider Adapter Registry and Capability Matrix](docs/screenshot-groups/group-201-204-provider-adapter-capability-matrix/)
- [Groups 197-200 - Connection Testing and Health Diagnostics](docs/screenshot-groups/group-197-200-connection-testing-health-diagnostics/)
- [Groups 193-196 - Configuration Readiness and Secret Boundaries](docs/screenshot-groups/group-193-196-configuration-readiness-secret-boundaries/)
...
LifeOS v28.0.0-alpha.21 is active through Group 204. Provider Adapter Registry &
Capability Matrix now has a real ordinary-mode local workspace on the shared
storage, forms and problem-state spine. SG-204 Pack 2 is closed with exact,
