...
- [Groups 205-208 - Provider Consent and Permission Profiles](docs/screenshot-groups/group-205-208-provider-consent-permission-profiles/)
...
LifeOS v28.0.0-alpha.22 completes configuration-free development through Group
208. Provider Consent & Permission Profiles now has a real ordinary-mode local
workspace on the shared storage, forms and problem-state spine. SG-208 Pack 2 is closed with exact,
