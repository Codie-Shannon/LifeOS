...
**Desktop v4.5 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Work Pipeline**
...
v4.6 turns local receipt or OCR output into reviewable evidence candidates. Imported fields remain untrusted until source-backed and manually accepted.

**Boundary:** v4.6 remains local/manual. No live OCR, scanner, inbox import, bank/accounting sync, OAuth, invoice creation, automatic payment state, or AI action is active.
<!-- LIFEOS_CURRENT_BUILD_END -->

<!-- LIFEOS_CURRENT_SCREENSHOTS_START -->
## Current screenshot evidence

- `docs/screenshot-groups/group-16-receipt-ocr-evidence-to-item/` - v4.6 Receipt OCR / Evidence-to-Item screenshots.
- `docs/release-notes/v4.6.md` - v4.6 release notes.
