...
> **Current checkpoint:** LifeOS v28.0.0-alpha.7 is active through Group 148. Projects is now a genuine ordinary-mode workspace with validated local capture, due and delivery state, proof references, versioned recovery and reversible archive. The preserved v27/Group 120 release candidate remains historical evidence, not a promise that feature development has ended.
...
| Product | Status |
|---|---|
| **LifeOS Desktop** | Current through Group 148, including ordinary-mode Projects, validated forms, actionable local problem states, ranked shell search, local-data recovery controls and the completed Career Documents Studio |
...
| **Current release lane** | v28 Career Documents Studio; CVs, cover letters and application-pack integration implemented through Pack 1 |
