...
> **Current checkpoint:** LifeOS v28.0.0-alpha.12 is active through Group 168. Life Routines & Personal Administration now provides validated local commitments, next actions and explicit state transitions without automatic scheduling, messaging or payment. The preserved v27/Group 120 release candidate remains historical evidence, not a promise that feature development has ended.
...
| Product | Status |
|---|---|
| **LifeOS Desktop** | Current through Group 168, including ordinary-mode Life, Household, Documents, Money Pressure, Work Time and Projects, validated forms, actionable problems and local-data recovery |
...
| **Current release lane** | v28 ordinary-mode productization; Life Routines and Personal Administration implemented through SG-168 Pack 1 |
...
LifeOS v28.0.0-alpha.12 is active through Group 168. Life Routines & Personal
Administration now has a real ordinary-mode local workspace on the shared
storage, forms and problem-state spine. SG-168 Pack 1 is implemented and visible
