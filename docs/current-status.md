...
LifeOS now has local-first foundations for:

- command centre pressure signals
- evidence/proof metadata
- relationship/waiting-on state
...
- OS Navigation module map
- protected/pinned core module map
- workspace group map
