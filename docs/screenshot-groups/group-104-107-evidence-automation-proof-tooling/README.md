...
SG-77 demonstrates old-evidence exclusion, stable screenshot naming,
...
2. `02-desktop-evidence-automation-overview.png` - SG-77 boundary and metrics.
...
6. `06-group77-validation.png` - complete validation proof.

## Verification

- SG-77 targeted tests: 4 passed, 0 failed
...
- Mobile feature screenshots: not applicable; SG-77 only aligns Mobile version
