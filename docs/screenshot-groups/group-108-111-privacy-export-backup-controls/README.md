...
SG-111 demonstrates independently permissioned sensitive categories,
...
2. `02-desktop-privacy-control-overview.png` - SG-111 boundary and metrics.
...
5. `05-sg111-validation.png` - complete validation proof.

## Verification

- SG-111 targeted tests: 8 passed, 0 failed
...
- Mobile feature screenshots: not applicable; SG-111 only aligns Mobile version
