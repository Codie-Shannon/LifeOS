...
- Public privacy and retired-name scan: passed
- Git diff check: passed
- Private-data review: passed

## Pack boundary

This folder is Pack 2 evidence only. Product code, tests and the generated
social-preview asset were committed separately in Pack 1.
