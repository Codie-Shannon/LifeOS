...
SG-80 closes the approved Groups 117-120 implementation lane with an
...
2. `02-desktop-release-candidate-overview.png` - SG-80 boundary and metrics.
...
9. `09-group80-validation.png` - validation proof and uncreated-tag boundary.
