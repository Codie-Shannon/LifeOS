...
SG-98 demonstrates review-first Afterpay and Zip evidence parsing, duplicate
...
2. `02-desktop-pay-later-review-overview.png`
   ...
   - Shows the SG-98 boundary, NZD 360 remaining, NZD 90 next deductions, two
...
- SG-98 targeted tests: 4 passed, 0 failed
...
- Mobile feature screenshots: not applicable; SG-98 only aligns Mobile version
