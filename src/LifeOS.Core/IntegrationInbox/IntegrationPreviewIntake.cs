...
public static class IntegrationPreviewIntake
{
    public static IntegrationPreviewItem CreatePreview(IntegrationPreviewDraft draft)
    {
        ...
        return new IntegrationPreviewItem
        {
            ...
            ConnectorKey = string.IsNullOrWhiteSpace(draft.ConnectorKey) ? draft.SourceLabel.Trim() : draft.ConnectorKey.Trim(),
            ProviderAccountLabel = draft.ProviderAccountLabel.Trim(),
            ProviderContainerId = draft.ProviderContainerId.Trim(),
