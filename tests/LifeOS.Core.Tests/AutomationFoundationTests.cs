...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("16.0.0-alpha.1", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v16.0.0-alpha.1", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v16 Documentation Hub", LifeOS.Core.ProductVersion.ReleaseName);
    }
