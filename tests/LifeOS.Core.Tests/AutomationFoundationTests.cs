...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.7", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.7", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Projects and Delivery", LifeOS.Core.ProductVersion.ReleaseName);
    }
