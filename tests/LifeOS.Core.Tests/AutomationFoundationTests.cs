...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.8", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.8", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Work Time and Billable Records", LifeOS.Core.ProductVersion.ReleaseName);
    }
