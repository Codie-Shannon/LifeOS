...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.17", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.17", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Accounts and Local-First Sync Foundation", LifeOS.Core.ProductVersion.ReleaseName);
    }
