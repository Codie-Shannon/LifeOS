...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.19", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.19", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Configuration Readiness and Secret Boundaries", LifeOS.Core.ProductVersion.ReleaseName);
    }
