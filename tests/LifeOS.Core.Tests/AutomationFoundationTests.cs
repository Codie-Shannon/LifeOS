...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.9", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.9", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Money Pressure and Safe to Spend", LifeOS.Core.ProductVersion.ReleaseName);
    }
