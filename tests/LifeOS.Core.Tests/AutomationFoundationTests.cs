...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.13", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.13", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Weekly Review and Personal Planning", LifeOS.Core.ProductVersion.ReleaseName);
    }
