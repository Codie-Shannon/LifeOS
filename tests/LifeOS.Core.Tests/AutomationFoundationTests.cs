...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.16", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.16", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Relationships and Contact Context", LifeOS.Core.ProductVersion.ReleaseName);
    }
