...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.15", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.15", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Focus Timer and Session Control", LifeOS.Core.ProductVersion.ReleaseName);
    }
