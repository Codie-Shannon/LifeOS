...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.12", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.12", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Life Routines and Personal Administration", LifeOS.Core.ProductVersion.ReleaseName);
    }
