...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.14", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.14", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Agenda and Commitment Planning", LifeOS.Core.ProductVersion.ReleaseName);
    }
