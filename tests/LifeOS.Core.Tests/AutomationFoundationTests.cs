...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.1", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.1", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Career Documents Studio", LifeOS.Core.ProductVersion.ReleaseName);
    }
