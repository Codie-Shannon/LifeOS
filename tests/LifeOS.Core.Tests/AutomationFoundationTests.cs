...
public sealed class AutomationFoundationTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.18", LifeOS.Core.ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.18", LifeOS.Core.ProductVersion.Display);
        Assert.Equal("v28 Device Transfer and Conflict Review", LifeOS.Core.ProductVersion.ReleaseName);
    }
