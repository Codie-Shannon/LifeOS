...
public sealed class Group39BetaReleaseTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.4", ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.4", ProductVersion.Display);
        Assert.Equal("v28 Local Data and Recovery Spine", ProductVersion.ReleaseName);
    }
