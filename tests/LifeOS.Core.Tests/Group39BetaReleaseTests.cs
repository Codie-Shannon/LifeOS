...
public sealed class Group39BetaReleaseTests
{
    ...
    {
        Assert.Equal("28.0.0-alpha.5", ProductVersion.Semantic);
        Assert.Equal("v28.0.0-alpha.5", ProductVersion.Display);
        Assert.Equal("v28 Navigation and Shell Search", ProductVersion.ReleaseName);
    }
