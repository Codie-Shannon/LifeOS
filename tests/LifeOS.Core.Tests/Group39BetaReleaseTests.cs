...
public sealed class Group39BetaReleaseTests
{
    ...
    {
        Assert.Equal("23.0.0-alpha.1", ProductVersion.Semantic);
        Assert.Equal("v23.0.0-alpha.1", ProductVersion.Display);
        Assert.Equal("v23 Grocery Intelligence", ProductVersion.ReleaseName);
    }
